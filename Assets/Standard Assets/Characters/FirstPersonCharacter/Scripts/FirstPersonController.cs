...
namespace UnityStandardAssets.Characters.FirstPerson
{
    public class FirstPersonController : MonoBehaviour
    {
                ...
                switch (touch.phase)
                {
                    ...
                    case TouchPhase.Moved:
                        ...
                        else if (touch.fingerId == leftFingerId)
                        {
                            ...
                            m_Input = touch.position - moveTouchStartPosition;
                        }
        ...
        private void Move()
        {
            ...
            if (m_Input.sqrMagnitude <= moveInputDeadZone) return;

            // Multiply the normalized direction by the speed
            Vector2 movementDirection = m_Input.normalized * m_WalkSpeed * Time.deltaTime;

            // Move relatively to the local transform's direction
            m_CharacterController.Move(transform.right * movementDirection.x + transform.forward * movementDirection.y);
        }
    }
